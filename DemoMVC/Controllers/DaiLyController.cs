...
namespace DemoMVC.Controllers
{
    public class DaiLyController : Controller
    {
        ...
        {
              return _context.DaiLy_1 != null ? 
                          View(await _context.DaiLy_1.ToListAsync()) :
                          Problem("Entity set 'ApplicationDbContext.DaiLy_1'  is null.");
        }

        // GET: DaiLy/Details/5
        public async Task<IActionResult> Details(string id)
        {
            if (id == null || _context.DaiLy_1 == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.DaiLy_1 == null)
            {
                return Problem("Entity set 'ApplicationDbContext.DaiLy_1'  is null.");
            }
            var daiLy = await _context.DaiLy_1.FindAsync(id);
            if (daiLy != null)
            {
        ...
        {
          return (_context.DaiLy_1?.Any(e => e.MaDaiLy == id)).GetValueOrDefault();
        }
    }
}
